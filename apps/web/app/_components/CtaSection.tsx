    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/register"
            className="px-8 py-4 rounded-xl bg-brand-primary text-btn-primary font-bold shadow-lg shadow-brand-primary/20 transition-all hover:shadow-brand-primary/40 hover:bg-brand-primary/90 hover:scale-105 active:scale-95"
          >
            Create Account
          </Link>
          <Link
