      ...
      <main className="flex-1 py-10 min-w-0">
        ...
        <div className="max-w-none">
          ...
          <Callout variant="tip" title="Everything is project-scoped">
            Every module you use in DevMatrix attaches to a Project. Create one
            project per app or team, and every request, error, metric, and idea
            report lives under it.
          </Callout>
