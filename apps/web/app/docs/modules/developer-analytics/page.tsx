      ...
      <main className="flex-1 py-10 min-w-0">
        ...
        <div className="max-w-none">
          ...
          <Callout variant="warning" title="This module needs the most setup">
            Unlike API Playground, Developer Analytics depends on external OAuth
            connections and background data processing — expect an initial sync
            delay after connecting a new repository.
          </Callout>
