    ...
    <>
      <main className="flex-1 py-10 min-w-0">
        ...
        <div className="prose prose-invert prose-slate max-w-none">
          ...
          <SectionHeading id="setup-workspace">2. Setup your workspace</SectionHeading>
          <p className="text-slate-300 mb-4 text-sm leading-7">
            Initialize the DevMatrix client. If you're using TypeScript, the
            types are included out of the box. Create a new file called{" "}
...
export const matrix = new MatrixClient({
  ...
  options: {
    ...
    syncWorkflows: true
          ...
          <SectionHeading id="create-project">3. Create your first project</SectionHeading>
          <p className="text-slate-300 mb-4 text-sm leading-7">
            Every module — API Playground, AI Debugging, Analytics, and the
            Idea Validator — needs a project to attach to. Create one from
            the client:
          </p>
          <CodeBlock
...
console.log(project.id); // use this in the dashboard`}
          ...
          <Callout variant="tip" title="Pro Tip">
            You can seamlessly integrate DevMatrix with your Next.js App
            Router API routes to handle authentication and webhooks directly
